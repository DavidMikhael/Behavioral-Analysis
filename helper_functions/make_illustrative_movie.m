...
tracked_videos = [{'A:/MATLAB/Videos/cam1.mp4';};];    %this variable is only to be filled when you have acquired videos for tracking
...
path_to_csv = [{'A:/MATLAB/CSVfiles/Exp_no_demDLC_dlcrnetms5_First ExperimentJun28shuffle1_200000_el.csv'};]; %provide csv file order should
 %correspond to the movie file order;

%% Plotter (no more user input needed here onwards)
          

load(['A:/MATLAB/AllExperiments/Experiment1/Data3d/Data3d.mat'],'coords3d')
...
DataAll = nan(nframes,nfeatures*4,ncams_to_display ) ;
