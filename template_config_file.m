...
nfeatures = 10; %Edit this to match your current experiment
...
ncams = 3; %Edit this to match your current experiment (minimum allowed value is 2)
...
primary2D_datafullpath     = {'A:/MATLAB/CSVfiles/647_primary-0000DeepCut_resnet50_David_2Jul12_shuffle1_300000.csv'}; 
...
secondary2D_datafullpath = [{'A:/MATLAB/CSVfiles/647_secondary1-0000DeepCut_resnet50_David_2Jul12_shuffle1_300000.csv'};...
                            {'A:/MATLAB/CSVfiles/647_secondary2-0000DeepCut_resnet50_David_2Jul12_shuffle1_300000.csv'}];
...
% images
folderwithpngs = 'A:/MATLAB/CalibImages/';

%total number of frames in your experiment video or total number of images
nframes = 10000; %Enter this value IF plotresults is set to 0, otherwise it's autofilled based on the link to the video/images you provide
...
path_to_2Dtracked_video = 'A:/MATLAB/Videos/cam1.mp4'; %full path of the 2D video you have tracked from **primary camera** to visualize alongside 3D tracked results
...
nskip = 60; %(integer) min value nskip can take is 1, increase this when you have long recording (plots results from every nskip frames, however 3D reconstruction is done for all frames)

% the DLC based likelihood value threshold
llh_thresh = 0.1; %Can choose values between 0 and 1; 
